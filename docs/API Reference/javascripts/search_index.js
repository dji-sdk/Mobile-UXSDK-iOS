var search_data = {
    "index": {
        "searchIndex": [
             ...
             "annotation of a fly zone that can be self-unlocked, currently on the map. only visible when duxmapwidget_taptounlockenabled is set to `true`.",
             "duxmapannotationtypeunlockedflyzones",
             "annotation of a fly zone that is unlocked currently. only visible when duxmapwidget_taptounlockenabled is set to `true`.",
             "duxmapannotationtypecustomunlockedflyzones",
             "annotation of a fly zone that is a custom unlock zone. only visible when duxmapwidget_taptounlockenabled is set to `true`.",
             "mapview",
             ...
             "taptounlockenabled",
             "a boolean value indicating if tapping to unlock select fly zones is enabled. only self-unlocking is supported at this time.  if this option is enabled, you must use `duxmapviewcontroller` to present the widget via view controller containment.",
             ...
             "showflyzonelegend",
             "boolean value controlling whether the fly zone legend is shown inside the map view controller. the fly zone legend indicates the color for all zone categories and self-unlocked zones.",
        ...
        "info": [
            ...
            [
                   ...
                   2,
                   "/Widgets/DUXMapWidget.html",
                   "#DUXMapWidget_tapToUnlockEnabled_inline",
                   "A boolean value indicating if tapping to unlock select fly zones is enabled. Only self-unlocking is supported at this time.  If this option is enabled, you MUST use `DUXMapViewController` to present the widget via view controller containment.",
            ],
            [
                   "A boolean value indicating if tapping to unlock select fly zones is enabled. Only self-unlocking is supported at this time.  If this option is enabled, you MUST use `DUXMapViewController` to present the widget via view controller containment.",
