var search_data = {
    "index": {
        "searchIndex": [
             ...
             "dulmapviewcontroller",
             "subclass of dulcontentviewcontroller which manages the logic for showing  the map view.",
             "mapwidget",
             ...
             "dulcapturewidget",
             "display: in shooting photo, the widget can show the mode of photo will be taken and the related setting of that mode as following:   - single mode.   - hdr mode.   - burst mode and the number of burst shot will be taken.   - aeb mode and the number of shot will be taken.   - interval mode.  usage: preferred aspect ratio: 49:65. check `dultrailingbarviewcontroller` for an example of its usage.  interaction: tapping when in shoot photo mode will take a photo. tapping when in record video mode will start/stop recording.",
             ...
             "this panel is built on top of `dulpreflightchecklistmanager`  display: panel that shows the preflight checklist that includes a list of items (like imu, gps etc) and their state that roll up into an overall state.  interaction: all the settings are presented in listview hierarchy.",
             ...
             "dulsdkmodel",
             "the dulsdkmodel is the bridge between the sdk which provides the communication with the aircraft and the uilibrary which give a visual rendering on the data received. it is integrated with the any object conforming to dulobjectprotocol and is used when customizing objects to register to different sdk keys or to receive live view video.",
             "defaultsdkmodel",
             ...
             "this method is called by the uilibrary coremodel when a value has been received from the aircraft. it is the entry point in the object for aircraft data.  @param value the value associated with the key. @param key the sdk key as registered in the dependentkey",
             "update",
        ...
        "info": [
            ...
            [
                   "DULMapViewController",
                   2,
                   "/Widgets/DULMapViewController.html",
                   "",
                   "Subclass of DULContentViewController which manages the logic for showing  the map view.",
            ],
            [
            ...
            [
                   ...
                   2,
                   "/Widgets/DULMapViewController.html",
                   "#DULMapViewController_mapWidget_inline",
                   "Instance of the map widget which is shown.",
            ],
            [
                   "Instance of the map widget which is shown.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULAircraftBatteryChecklistItem.html",
                   "#DULAircraftBatteryChecklistItem_minimumOperationalThreshold_inline",
                   "Property that sets a minimum value threshold the battery percentage must be at in order to show a good state.  The default value is 0.",
            ],
            [
                   "Property that sets a minimum value threshold the battery percentage must be at in order to show a good state.  The default value is 0.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULAircraftBatteryChecklistItem.html",
                   "#DULAircraftBatteryChecklistItem_initWithMinimumOperationalThreshold_inline",
                   "Custom initializer that will set the minimum battery threshold.  @param minimumOperationalThreshold Minimum operational threshold.",
            ],
            [
                   "Custom initializer that will set the minimum battery threshold.  @param minimumOperationalThreshold Minimum operational threshold.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULSDKModel.html",
                   "#DULSDKModel_unregisterDependentKeysForObject_inline",
                   "Removes data watching for all dependentKeys of a given object.  @param object The object for which we unregister the keys.",
            ],
            [
                   "Removes data watching for all dependentKeys of a given object.  @param object The object for which we unregister the keys.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULSDKModel.html",
                   "#DULSDKModel_registerDependentKeysForObject_inline",
                   "Allows an object to register dependent keys and receive data updates as soon as it is available.  @param object The object for which we register the keys. @param dependentKeys The dependent keys which we are registering.",
            ],
            [
                   "Allows an object to register dependent keys and receive data updates as soon as it is available.  @param object The object for which we register the keys. @param dependentKeys The dependent keys which we are registering.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULSDKModel.html",
                   "#DULObjectProtocol_dependentKeys_inline",
                   "An array of DJIKey to be used by the UILibrary CoreModel in order to retrieve data from the SDK automatically.  @return the list of dependent keys",
            ],
            [
                   "An array of DJIKey to be used by the UILibrary CoreModel in order to retrieve data from the SDK automatically.  @return the list of dependent keys",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULSDKModel.html",
                   "#DULObjectProtocol_transformValueforKey_inline",
                   "This method is called by the UILibrary CoreModel when a value has been received from the aircraft. It is the entry point in the object for aircraft data.  @param value the value associated with the key. @param key the SDK key as registered in the dependentKey",
            ],
            [
                   "This method is called by the UILibrary CoreModel when a value has been received from the aircraft. It is the entry point in the object for aircraft data.  @param value the value associated with the key. @param key the SDK key as registered in the dependentKey",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULSDKModel.html",
                   "#DULObjectProtocol_update_inline",
                   "Method that is automatically called once the data has been used by transform.",
            ],
            [
                   "Method that is automatically called once the data has been used by transform.",
            ...
            [
                   "DULVisualizerWidget",
                   2,
                   "/Widgets/DULVisualizerWidget.html",
                   "",
                   "Widget for the visualizer.",
            ],
            [
            ...
            [
                   ...
                   2,
                   "/Widgets/DULVisualizerWidget.html",
                   "#DULVisualizerWidget_showExpectedTimeLine_inline",
                   "Show the expected timeline from the DJIMissionControlTimelineElement  elements on the Visualizer.  @param elements NSArray of DJIMissionControlTimelineElement objects.",
            ],
            [
                   "Show the expected timeline from the DJIMissionControlTimelineElement  elements on the Visualizer.  @param elements NSArray of DJIMissionControlTimelineElement objects.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULVisualizerWidget.html",
                   "#DULVisualizerWidget_showHomeOnVisualizer_inline",
                   "Show and hides the aircraft home location on the Visualizer.  By default the value of showHome is TRUE.  @param showHome YES to show the aircraft home location.",
            ],
            [
                   "Show and hides the aircraft home location on the Visualizer.  By default the value of showHome is TRUE.  @param showHome YES to show the aircraft home location.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULVisualizerWidget.html",
                   "#DULVisualizerWidget_showRealTimeFlightPath_inline",
                   "Show and hides the real flight path on the Visualizer.  By default the value of showRealtimeFlight is TRUE.  @param showRealtimeFlight YES to show real time flight. @param deltaBuffer Delta buffer value between points.",
            ],
            [
                   "Show and hides the real flight path on the Visualizer.  By default the value of showRealtimeFlight is TRUE.  @param showRealtimeFlight YES to show real time flight. @param deltaBuffer Delta buffer value between points.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULVisualizerWidget.html",
                   "#DULVisualizerWidget_followAircraft_inline",
                   "The camera will follow the aircraft. By default the  value of followAircraft is TRUE.  @param followAircraft If YES, the camera will follow the aircraft.",
            ],
            [
                   "The camera will follow the aircraft. By default the  value of followAircraft is TRUE.  @param followAircraft If YES, the camera will follow the aircraft.",
            ...
            [
                   ...
                   2,
                   "/Widgets/DULVisualizerWidget.html",
                   "#DULVisualizerWidget_clearVisualizer_inline",
                   "Will remove all the nodes from the visualizer except home and aircraft.",
            ],
            [
                   "Will remove all the nodes from the visualizer except home and aircraft.",
