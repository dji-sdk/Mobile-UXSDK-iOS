var search_data = {
    "index": {
        "searchIndex": [
             ...
             "annotation of a self-unlock fly zone that can be unlocked, currently on the map. only visible when duxmapwidget_taptounlockenabled is set to `true`.",
             "duxmapannotationtypeunlockedflyzones",
             "annotation of a self-unlock fly zone that is unlocked currently. only visible when duxmapwidget_taptounlockenabled is set to `true`.",
             "duxmapannotationtypecustomunlockedflyzones",
             "annotation of a custom unlock fly zone. only visible when duxmapwidget_taptounlockenabled is set to `true`.",
             "mapview",
             ...
             "showflightpath",
             "defaults to `no`. a boolean value indicating whether the map displays a line of aircraft's flight path.",
             "showhomeannotation",
             ...
             "taptounlockenabled",
             "a boolean value indicating if tapping to unlock select fly zones is enabled.  if this option is enabled, you must use `duxmapviewcontroller` to present the widget via view controller containment.",
             ...
             "showflyzonelegend",
             "boolean value controlling whether the fly zone legend is shown inside the map view controller. the fly zone legend indicates the color for all zone categories and self-unlock zones.",
