 ...
 *  its `isZoomSupported` state. It will give the correct values of
 ...
 */
@property (nonatomic, copy) void (^zoomSupportChangedWithData)(BOOL isZoomSupported, NSUInteger minFocalLength, NSUInteger maxFocalLength, NSUInteger currentFocalLength);
